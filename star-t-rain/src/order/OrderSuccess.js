    ...
    return (
        <div>
            <nav class="md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center mb-5 px-4">
                ...
                <Link to="/bun-bo-tho-da" class="mr-16 font-normal active:text-4C8787 active:border-4C8787 active active:border-solid active:border-1px">Thành Công</Link>
                <Link to="/restaurant" class="mr-16 font-normal active:text-4C8787 active:border-4C8787 active:border-solid active:border-1px">Đã Hủy</Link>
            </nav>
